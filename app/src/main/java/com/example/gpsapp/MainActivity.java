...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_altitude = findViewById(R.id.tv_latitude);
    ...
    public void gps_onClick(View view) {
        if (sw_gps.isChecked()) {
            ...
            locationRequest.setPriority(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
            tv_sensor.setText("Using WiFi and Tower");

        }
    }

    //To taking permission
    @Override
    ...
    private void startLocationUpdates() {
        ...
        if (androidx.core.app.ActivityCompat.checkSelfPermission(this, android.Manifest.permission.
                ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && androidx.core.app.ActivityCompat.checkSelfPermission
